...
function init() {
	...
	var Building = function Building(width) {
		...
		this.texture = THREE.ImageUtils.loadTexture('https://s3-us-west-2.amazonaws.com/s.cdpn.io/322806/concrete.png');
	...
	Building.prototype.position = function (x, y, z) {
		...
		this.mesh.position.y = y + offsetY;
	...
	function renderScene() {
		...
		camera.lookAt(city.scene.position);
		renderer.render(city.scene, camera);
