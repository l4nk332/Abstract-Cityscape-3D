...
var gui = new dat.GUI();
gui.add(controls, 'cameraX', -3000, 3000);
gui.add(controls, 'cameraY', 0, 3000);
gui.add(controls, 'cameraZ', -3000, 3000);
...
function init() {
	camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.1, 300000);
	...
	function renderScene() {
		...
		camera.lookAt(new THREE.Vector3(city.size / 4, 0, city.size / 4));
